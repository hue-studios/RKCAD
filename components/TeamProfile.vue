...
<template>
	<div
		id="team-profile"
		class="flex items-center justify-center md:justify-center flex-col team-profile"
		@click="closeProfile"
	>
		<div class="absolute close-btn cursor-pointer">
			<Icon name="Close" />
		</div>
		<div
			id="team-content"
		...
		>
			<transition name="fade" mode="out-in">
				<div
					...
					class="team-profile__content-image shadow-xl"
					:style="'background-image: url(https://admin.rkcad.com/assets/' + profileStore.profile.image + '?key=medium'"
				></div>
			...
			<div class="team-profile__content-body">
				...
				<div v-if="profileStore.profile.quote" class="team-profile__quote" v-html="profileStore.profile.quote"></div>
