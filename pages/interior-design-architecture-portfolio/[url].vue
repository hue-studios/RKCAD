<template>
  <div class="relative w-full px-4 project">
    <div class="w-full project__slideshow">
      <UtilitiesSlideshow :slides="project.images" />
    </div>
    <div
      class="w-full flex items-start lg:items-end flex-col lg:flex-row justify-between uppercase tracking-wide mt-20 project__header"
    >
      <h1 class="relative">
        {{ project.title }}
        <span class="hidden">
    ...
    <div
      class="flex items-center flex-col lg:flex-row justify-start tracking-wide my-20 project__content"
    >
