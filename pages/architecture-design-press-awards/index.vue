...
onMounted(() => {
	...
	image.src = 'https://admin.rkcad.com/assets/' + press.header_image + 'key=xlarge'
...
<template>
	...
	>
		<div
			class="page__header"
			:style="'background-image: url(https://admin.rkcad.com/assets/' + press.header_image + ')'"
		>
		...
		<div class="flex flex-wrap flex-row items-center justify-stretch w-full page__body">
			<div class="w-full uppercase mt-20 mb-10 page__body-header">
				...
				<p v-if="press.introduction" class="normal-case mb-6 page__body-header-intro">
					{{ press.introduction }}
				</p>
			</div>
