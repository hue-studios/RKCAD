...
onMounted(() => {
	...
	image.src =
		'https://admin.rkcad.com/assets/' + team.header_image + '?key=xlarge'
...
<template>
	...
	>
		...
		>
			...
			<div
				class="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 sm:gap-9"
			>
				<CardsTeamCard
			...
			<div
				class="w-full flex items-start justify-center flex-col lg:flex-row flex-wrap mt-20 employment"
			>
				...
				<div
					class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-9"
				>
					<div
