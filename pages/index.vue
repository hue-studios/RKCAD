...
const work = [...home.featured_projects]
		...
		<div class="w-full page__header-placeholder">
			<transition name="fade" mode="out-in">
				<div v-if="isImageLoaded" class="w-full page__header-placeholder">
					<transition name="fade" mode="out-in">
						<div
							v-if="showIntroAnimation && isImageLoaded"
							id="animation"
						...
						<div v-else class="flex items-center justify-center flex-col page__header">
							...
							>
								<swiper-slide
									v-for="(slide, index) in home.featured_images"
									:key="index"
		...
		<div class="flex flex-wrap flex-row items-center justify-center w-full page__body">
			...
			<div class="w-full page__body-header">
				...
				>
					...
					<img
						v-if="home.team_image"
						alt="RKC Team"
						class="w-full md:w-1/2 h-auto mt-4 mb-8 shadow-xl"
						:srcset="
							imageUrl +
							home.team_image +
							'?key=small 400w, ' +
					...
					<div class="w-full flex items-start flex-col mt-12 xl:-mt-2 2xl:-mt-10">
						...
						>
							<div
								class="flex items-start justify-start flex-col md:flex-row relative w-full"
								:class="{
									'lg:w-1/2': home.featured_profile.featured_projects.length,
								}"
							>
								<img
								...
								<div
									class="mt-4 md:mt-0 md:ml-2 flex items-end justify-end flex-col home-section__quote"
									v-html="home.featured_profile.quote"
								></div>
							</div>
							<UtilitiesDesignerProjects
								v-if="home.featured_profile.featured_projects.length"
								:name="home.featured_profile.name"
				...
				<div v-if="home.featured_project" class="w-full page__body-header">
					...
					>
						...
						<img
							v-if="home.featured_project.images.length"
							:alt="removeFirst(home.featured_project.title) + ' by RKC'"
							class="w-full md:w-1/2 h-auto mt-8 md:mt-4 mb-8 shadow-xl"
							:srcset="
								imageUrl +
